...
public class sendSMS  {    
	...
	public static void sendsms(Context context, final String phoneNumber, final String message, final Boolean AddtoSent)	{
		try {
			String SENT = "SMS_DELIVERED";
			Intent myIntent = new Intent(SENT);
	    	PendingIntent sentPI = PendingIntent.getBroadcast(context, 0, myIntent, 0);
